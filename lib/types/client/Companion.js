...
export function Companion({ useSessions, useSessionPendingInteraction, useStore, actions, t }) {
    ...
    const pendingInteraction = useSessionPendingInteraction?.(interactions => summary === undefined ? undefined : interactions.get(summary.id)?.kind)
